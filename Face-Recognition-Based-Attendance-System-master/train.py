...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System", bg="Black", fg="white", width=58,
...
lbl2 = tk.Label(window, text="Enter Name", width=20, height=2, fg="Black", bg="white", font=('times', 15, ' bold '))
...
clearButton = tk.Button(window, text="Clear", command=clear, fg="white", bg="black", width=20, height=2,
                        activebackground="Red", font=('times', 15, ' bold '))
clearButton.place(x=550, y=200)
clearButton2 = tk.Button(window, text="Clear", command=clear2, fg="white", bg="black", width=20, height=2,
                         activebackground="Red", font=('times', 15, ' bold '))
clearButton2.place(x=550, y=300)
takeImg = tk.Button(window, text="Take Images", command=TakeImages, fg="white", bg="black", width=20, height=3,
                    activebackground="Red", font=('times', 15, ' bold '))
takeImg.place(x=1100, y=200)
trainImg = tk.Button(window, text="Train Images", command=TrainImages, fg="white", bg="black", width=20, height=3,
                     activebackground="Red", font=('times', 15, ' bold '))
trainImg.place(x=1100, y=300)
trackImg = tk.Button(window, text="Track Images", command=TrackImages, fg="white", bg="black", width=20, height=3,
                     activebackground="Red", font=('times', 15, ' bold '))
trackImg.place(x=1100, y=400)
